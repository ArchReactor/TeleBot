...
void RobotCore::setMotors() {
	if (motorMode == 'S') {
		Rservo.write(map(spdCurR, -255, 255, 180, 0)); //invert since 0=full speed FWD and 90=stop and 180=full REV
		Lservo.write(map(spdCurL, -255, 255, 180, 0)); //invert since 0=full speed FWD and 90=stop and 180=full REV
	}
	if (motorMode == 'H') {
